...
import {statusChanged, colorChanged} from "../../redux/todolist/filters/actions";
    ...
    return (
        <div className="mt-4 flex justify-between text-xs text-gray-500">
            ...
            <ul className="flex space-x-1 items-center text-xs">
                <li 
                className={status === "All" ? "cursor-pointer font-bold" : "cursor-pointer"}
                onClick={() => handleStatusChange("All")}>
                    All
                </li>
                <li>|</li>
                <li className={status === "Incomplete" ? "cursor-pointer font-bold" : "cursor-pointer"} 
                    onClick={() => handleStatusChange("Incomplete")}>
                    Incomplete
                </li>
                <li>|</li>
                <li className={status === "Complete" ? "cursor-pointer font-bold" : "cursor-pointer"} 
