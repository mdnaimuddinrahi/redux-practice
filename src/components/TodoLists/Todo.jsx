...
import {toggled, colorSelected} from '../../redux/todolist/todos/actions'
        ...
        >
            ...
            <div
                className={`flex-shrink-0 h-4 w-4 rounded-full border-2 ml-auto cursor-pointer 
                    ${color === "green" ? "border-green-500 hover:bg-green-500 bg-green-500" : ""}`}
                onClick={() => handleColorChange(id, "green")}
            ></div>

            <div
                className={`flex-shrink-0 h-4 w-4 rounded-full border-2 ml-auto cursor-pointer 
                    ${color === "yellow" ? "border-yellow-500 hover:bg-yellow-500 bg-yellow-500" : ""}`}
