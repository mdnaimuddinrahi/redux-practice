...
import { removeBooking } from "../redux/flightbook/actionCreators";

function FlightBookList() {
                ...
                {bookings.map(booking => (
                    <tr key={booking.id} className="lws-bookedTable text-black">
                        <td className="px-6 py-4">
                            ...
                            <p className="lws-bookedFrom">{booking.id}</p>
                            </div>
                        </td>
                        <td className="px-6 py-4">
                            <div className="flex items-center space-x-3">
                        ...
                        <td className="px-6 py-4 text-center">
                            <p className="lws-bookedDate">{booking.journey_date}</p>
                        </td>
                        <td className="px-6 py-4 text-center">
                            <p className="lws-bookedGustes">{booking.guests}</p>
                        </td>
                        <td className="px-6 py-4 text-center">
                            <span className="lws-bookedClass"> {booking.ticket_class} </span>
                        </td>
